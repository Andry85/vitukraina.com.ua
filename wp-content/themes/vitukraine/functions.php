<?php 
	...
	function vit_script_enqueue() {
		...
		wp_enqueue_script('customjs-1', get_template_directory_uri().'/libs/jquery.slicknav.min.js', array(), '1.0.0',true);
		wp_enqueue_script('customjs-2', get_template_directory_uri().'/libs/owl.carousel.min.js', array(), '1.0.0',true);
